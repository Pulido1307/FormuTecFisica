...
import com.tecnm.campusuruapan.formutecfisica.ComplaintSuggestionsActivity;
...
private ComplaintSuggestionsActivity complaintSuggestionsActivity;
private String nombre;
private  boolean tipo;

public EnviarEmail(Session session, String from, String to, String message, ComplaintSuggestionsActivity complaintSuggestionsActivity, String nombre, boolean tipo) {
        this.session = session;
        this.from = from;
        this.to = to;

        this.message = message;
        this.complaintSuggestionsActivity = complaintSuggestionsActivity;
        this.nombre=nombre;
        this.tipo=tipo;
...
protected String doInBackground(String... params) {
        ...
        mimeMessage.setFrom(new InternetAddress(from,"FormuTec Física"));
        mimeMessage.setRecipients(Message.RecipientType.TO, InternetAddress.parse(to));
        mimeMessage.setSubject("Gracias por ayudarnos a mejorar FormuTec Física");
